...
function crearUsuario() {
  ...
  // Devuelve la clase
  // Tu código:
  class Usuario {  //uso class porque estoy mas acostumbrado a las clases por Java
    ...
    /*saludar() {  //esto no tiene un "prototype", pero no se como ponerlo. Act: varias formas de crear func.
      return "Hola, mi nombre es " + this.nombre;
    }*/
  }
  return Usuario; 
  /*
   //como supuestamente es:    aunque no usa el comando "class"
